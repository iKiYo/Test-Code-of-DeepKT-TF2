...
import models.saint_plus
from .train_model import train_model
from data.saint_plus_data_preprocessor import prepare_batched_tf_data, make_sequence_data, get_kfold_id_generator
...
def do_one_time_cv_experiment(args):
  ...
  for i in range(num_fold):
    ...
    # initialize model
    model = models.saint_plus.SAINT_plus(args.num_layers, args.d_model, args.num_heads, args.dff,
...
def do_normal_experiment(args):
  ...
  # build model
  model = models.saint_plus.SAINT_plus(num_layers, d_model, num_heads, dff,
                          input_vocab_size, target_vocab_size,
                          pe_input=max_sequence_length, 
                          pe_target=max_sequence_length,
                          rate=dropout_rate)
